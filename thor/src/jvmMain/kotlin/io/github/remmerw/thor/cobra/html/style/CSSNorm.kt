...
object CSSNorm {
    ...
    fun stdStyleSheet(): String {
        return "html, address," +
                ...
                "h1, h2, h3, h4," +
                "h5, h6, noframes," +
                "ol, p, ul, center," +  // unicode-bidi: embed was missing in the style sheet provided by jStyle
                ...
                "h4, p," +  // according to https://developer.mozilla.org/en-US/docs/Web/HTML/Element/dir
                ...
                "pre             { white-space: pre }" +
                "button, textarea," +  // object selector was added by jStyle library, but since we don't support Object
     ...
     * @return The style string
     */
    fun userStyleSheet(): String {
        return "html   { overflow: auto; }" +  // makes sure that a links do not inherit cursor, they should have a default value
                ...
                "option { display: none; }" +
                "br     { display: block; }" +
                "hr     { display: block; margin-top: 1px solid; }" +  //standard <ul> margin according to Mozilla
                "ul     { margin-left: 0; padding-left: 40px; }" +  // In jStyleParser code, these were in the recommended section,
                // but we have moved them here as they are not part of the W3C recommendation.
                "abbr, acronym   { font-variant: small-caps; letter-spacing: 0.1em }" +  // In both Firefox and Chromium, text-align for tables is reset and not inherited
                "table {text-align: left}" +  // Adding some new html5 block elements
